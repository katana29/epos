        ...
        if($("input[name=odabir_tabele]:checked").length!=0 && $("input[name=http_zahtev]:checked").length!=0){
            ...
            switch ( $("input[name=http_zahtev]:checked")[0].id){
                ...
                case "put":
                    //kod za bonus poene
                    if(tabela=="radio_novosti"){
                //prikupljamo podatke kojima menjamo novost
                        var values1 = {
                            "naslov": $("input[name=naslov_novosti_put]").val(),
                            "tekst":$("#tekst_novosti_put").val(),
                            "kategorija_id": parseInt($("#kategorija_odabir_put").val())
                        };
                        //takodje uzimamo id novosti koju zelimo da promenimo
                        var id= $("input[name=id_novosti]").val();
                        var url1="http://localhost:8080/rest/rest/novosti/"+id;
                        console.log(values1);
                        console.log(id);
                        console.log(url1);
                        $.ajax({
                        ...
                        var id= $("input[name=id_kategorije]").val();
                        var url1="http://localhost:8080/rest/rest/kategorije/"+id;
                        console.log(values2);
                        console.log(id);
                        console.log(url1);
                        $.ajax({
                ...
                case "delete":
                    //kod za bonus poene
                    if(tabela=="radio_novosti"){
                        //uzimam id za brisanje
                        var id= $("input[name=brisanje]").val();
                        var url2="http://localhost:8080/rest/rest/novosti/"+id;
                        console.log(id);
                        console.log(url2);
                        $.ajax({
                            type:"DELETE",
                        ...
                        //uzimam id za brisanje
                        var id= $("input[name=brisanje]").val();
                        var url2="http://localhost:8080/rest/rest/kategorije/"+id;
                        console.log(id);
                        console.log(url2);
                        $.ajax({
                            type:"DELETE",
